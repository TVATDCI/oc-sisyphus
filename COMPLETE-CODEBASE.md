...
17 Named Agents (runtime): sisyphus (opencode-go/glm-5.2, ultrawork: opencode-go/kimi-k2.5), hephaestus (opencode-go/kimi-k2.5), oracle (zai-coding-plan/glm-5.2, high), librarian (opencode-go/minimax-m2.7), explore (opencode/deepseek-v4-flash-free), multimodal-looker (opencode-go/mimo-v2.5-pro), prometheus (opencode-go/kimi-k2.7-code), metis (opencode-go/kimi-k2.7-code), momus (opencode-go/qwen3.7-max), atlas (opencode-go/kimi-k2.6), sisyphus-junior (zai-coding-plan/glm-5-turbo), archivist (opencode-go/glm-5.1), athena (opencode/deepseek-v4-flash-free), auditor (opencode/deepseek-v4-flash-free), explorer (opencode/deepseek-v4-flash-free), post-reviewer (opencode-go/glm-5.1), reviewer (opencode-go/mimo-v2.5-pro)
9 Categories (via task(category='...')): deep→zai-coding-plan/glm-5-turbo, ultrabrain→opencode-go/deepseek-v4-pro, visual-engineering→opencode-go/mimo-v2.5-pro, quick→opencode/deepseek-v4-flash-free, unspecified-high→opencode-go/kimi-k2.7-code, unspecified-low→opencode/deepseek-v4-flash-free, writing→opencode-go/kimi-k2.5, artistry→opencode-go/mimo-v2.5-pro, git-commit-message→opencode/deepseek-v4-flash-free
Provider mix: agents lean opencode-go (11 of 17 primaries), zai-coding-plan (2: oracle, sisyphus-junior), opencode (4: explore, athena, auditor, explorer). Categories: opencode-go (5), opencode (3), zai-coding-plan (1: deep). Most constrained model: opencode-go/glm-5.2 (concurrency: 1) — primary for 1 agent (sisyphus); opencode-go/glm-5.1 (concurrency: 1) — primary for 2 agents (archivist, post-reviewer). zai-coding-plan/glm-5.2 is primary for oracle; zai-coding-plan/glm-5-turbo is primary for sisyphus-junior + deep category. mimo-v2.5-pro is primary for 2 agents (multimodal-looker, reviewer) + 2 categories (visual-engineering, artistry). Cost-reduction changes (Jun 24): oracle opencode/gpt-5.4→zai-coding-plan/glm-5.2, prometheus opencode-go/glm-5.2→opencode-go/kimi-k2.7-code, sisyphus-junior opencode-go/kimi-k2.6→zai-coding-plan/glm-5-turbo, deep category opencode-go/glm-5.1→zai-coding-plan/glm-5-turbo.
