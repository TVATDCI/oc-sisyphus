...
17 Named Agents (runtime): sisyphus (opencode-go/glm-5.2, ultrawork: opencode-go/kimi-k2.5), hephaestus (opencode-go/kimi-k2.5), oracle (opencode/gpt-5.4 high), librarian (opencode-go/minimax-m2.7), explore (opencode/deepseek-v4-flash-free), multimodal-looker (opencode-go/mimo-v2.5-pro), prometheus (opencode-go/glm-5.2), metis (opencode-go/kimi-k2.7-code), momus (opencode-go/qwen3.7-max), atlas (opencode-go/kimi-k2.6), sisyphus-junior (opencode-go/kimi-k2.6), archivist (opencode-go/glm-5.1), athena (opencode/deepseek-v4-flash-free), auditor (opencode/deepseek-v4-flash-free), explorer (opencode/deepseek-v4-flash-free), post-reviewer (opencode-go/glm-5.1), reviewer (opencode-go/mimo-v2.5-pro)
9 Categories (via task(category='...')): deep→opencode-go/glm-5.1, ultrabrain→opencode-go/deepseek-v4-pro, visual-engineering→opencode-go/mimo-v2.5-pro, quick→opencode/deepseek-v4-flash-free, unspecified-high→opencode-go/kimi-k2.7-code, unspecified-low→opencode/deepseek-v4-flash-free, writing→opencode-go/kimi-k2.5, artistry→opencode-go/mimo-v2.5-pro, git-commit-message→opencode/deepseek-v4-flash-free
